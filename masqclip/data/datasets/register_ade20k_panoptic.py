...
ADE20K_150_CATEGORIES = [
    ...
    # {"color": [64, 113, 177], "id": 0, "isthing": 0, "name": "wall"},
    # {"color": [216, 82, 24], "id": 1, "isthing": 0, "name": "building"},
    {"color": [6, 230, 230], "id": 2, "isthing": 0, "name": "sky"},
    # {"color": [236, 176, 31], "id": 2, "isthing": 0, "name": "sky"},
    {"color": [80, 50, 50], "id": 3, "isthing": 0, "name": "floor"},
    {"color": [4, 200, 3], "id": 4, "isthing": 0, "name": "tree"},
    # {"color": [125, 46, 141], "id": 4, "isthing": 0, "name": "tree"},
    ...
    # {"color": [255, 128, 192], "id": 8, "isthing": 1, "name": "window "},
    {"color": [4, 250, 7], "id": 9, "isthing": 0, "name": "grass"},
    # {"color": [107, 187, 232], "id": 9, "isthing": 0, "name": "grass"},
    {"color": [224, 5, 255], "id": 10, "isthing": 1, "name": "cabinet"},
    {"color": [235, 255, 7], "id": 11, "isthing": 0, "name": "sidewalk, pavement"},
    # {"color": [130, 169, 68], "id": 11, "isthing": 0, "name": "sidewalk, pavement"},
